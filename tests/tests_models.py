...
class PatientModelTest(TestCase):
    ...
    def setUp(self):
        self.test_user1 =  User(is_medic = True, is_patient = False, first_name = 'User Test', last_name = 'Model Test 1', comments = 'This is a test', save_session = False)
        self.test_user1.save()
        self.test_user2 =  User(is_medic = False, is_patient = True, first_name = 'User Test', last_name = 'Model Test 2', comments = 'This is a test', save_session = False)
...
class TrainingModelTest(TestCase):
    ...
    def test_training_creation(self):
       ...
       self.assertEquals(training_test.doctor.first_name, 'User Test')
...
class PatientTrainingModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.testpatient_training.save()
